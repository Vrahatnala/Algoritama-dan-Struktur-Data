...
int main ()
{
    ...
    if(menu==1){
        do {
            cout<<"Double Linked List Circular Non (DLLNC) (Head)"<<endl;
            cout<<"=========================================="<<endl;
        ...
        do {
            cout<<"Double Linked List Circular Non (DLLNC) (Head dan Tail)"<<endl;
            cout<<"==================================================="<<endl;
            cout<<"1. Tambah Depan"<<endl;
            cout<<"2. Tambah Belakang"<<endl;
            cout<<"3. Tampilkan Data"<<endl;
        ...
        cout<<"\nTERIMA KASIH"<<endl;
        cout<<"Program was made Fatih Alfayruz (2510817210011)."<<endl;
    }
}
